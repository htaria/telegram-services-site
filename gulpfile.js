...
gulp.task('compile-bootstrap', async function () {
    gulp.src('src/assets/css/bootstrap/scss/*.scss')
    .pipe(sass().on('error', sass.logError))
    .pipe(gulp.dest('dist/assets/css/bootstrap'));
});
...
gulp.task('compile-bootstrap-min', async function () {
    ...
    .pipe(cleanCSS({compatibility: 'ie8'}))
    .pipe(gulp.dest('dist/assets/css/bootstrap/min'));
});
...
gulp.task('watch',async function() {
    ...
    gulp.watch('src/assets/css/SASS/*.scss',gulp.series('compile-my-sass'));
    gulp.watch('src/assets/css/SASS/*.scss',gulp.series('compile-my-sass-min'));
    gulp.watch('src/assets/css/bootstrap/scss/*.scss',gulp.series('compile-bootstrap'));
    gulp.watch('src/assets/css/bootstrap/scss/*.scss',gulp.series('compile-bootstrap-min'));
    gulp.watch('src/assets/js/Plugins/*.jss',gulp.series('compile-Plugins-js'));
    gulp.watch('src/assets/css/Plugins/*.css',gulp.series('compile-Plugins-css'));
});
